...
zojaxContentSpaceLayer = functional.ZCMLLayer(
    os.path.join(os.path.split(__file__)[0], 'ftesting.zcml'),
    __name__, 'zojaxContentSpaceLayer', allow_teardown=True)
...
def test_suite():
    return unittest.TestSuite((
            FunctionalDocFileSuite("columns.txt"),
